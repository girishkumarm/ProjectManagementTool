...
import com.tool.management.generic.SendEmailInput;
...
public class SendEmail {
	...
	public boolean sendEmail( String emailTemplate, String bodyText, String userName, String passWord, String recipient,
			String subject )
	{
		...
		try
		{
			...
			{
				to.add(new String(toAddress.trim()));
			}
		...
		try
		{
			...
			if( sendEmailInput.getToAddresses() != null )
				if( !sendEmailInput.getToAddresses().isEmpty() )
					for( String toAdd : sendEmailInput.getToAddresses() )
					{
